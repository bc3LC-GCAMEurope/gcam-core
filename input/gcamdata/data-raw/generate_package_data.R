...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["TechFixOutSW"]] <- c(level2_data_names[["TechFixOut"]],  "share.weight.year", "subs.share.weight", "tech.share.weight")
  ...
  level2_data_names[["StubTechCaloriePriceConv"]] <- c(level2_data_names[["StubTechYr"]], "minicam.energy.input", "price.unit.conversion", "market.name")
  ...
  level2_data_names[["StubTechFixOutNoSW"]] <- c(level2_data_names[["StubTechYr"]], "fixedOutput")
  ...
  level2_data_names[["StubCaloriePriceConv"]] <- c("region", "supplysector", "subsector", "stub.technology", "year", "minicam.energy.input", "price.unit.conversion")
  ...
  level2_data_names[["StubTechFractSecOutMarket"]] <- c(level2_data_names[["StubTechFractSecOut"]], "market.name")
  level2_data_names[["StubTechFractSecMarket"]] <- c(level2_data_names[["StubTechYr"]], "fractional.secondary.output", "market.name")
  ...
  level2_data_names[["StubTechSecOutMarket"]] <- c(level2_data_names[["StubTechSecOut"]], "market.name")
  ...
  level2_data_names[["StubTranTechInterp"]] <- c(level2_data_names[["StubTranTech"]], "apply.to", "from.year", "to.year", "interpolation.function")
  ...
  level2_data_names[["PerCapitaBased_trn"]] <- c("region", "trn.final.demand", "perCapitaBased")
  level2_data_names[["BaseService"]] <- c("region", "energy.final.demand", "year", "base.service")
  level2_data_names[["BaseService_trn"]] <- c("region", "trn.final.demand", "year", "base.service")
  level2_data_names[["PriceElasticity"]] <- c("region", "energy.final.demand", "year", "price.elasticity")
  level2_data_names[["PriceElasticity_trn"]] <- c("region", "trn.final.demand", "year", "price.elasticity")
  level2_data_names[["IncomeElasticity"]] <- c("region", "energy.final.demand", "year", "income.elasticity")
  level2_data_names[["IncomeElasticity_trn"]] <- c("region", "trn.final.demand", "year", "income.elasticity")
  ...
  level2_data_names[["SubregionalShares_trn"]] <- c("region", "trn.final.demand", "pop.year.fillout", "inc.year.fillout", "subregional.population.share", "subregional.income.share")
  level2_data_names[["SubregionalShares_Year"]] <- c("region", "gcam.consumer", "subregional.population.share.year", "subregional.income.share.year", "subregional.population.share", "subregional.income.share")
  ...
  level2_data_names[["ThermalServiceAdder"]] <- c("region", "gcam.consumer", "nodeInput", "building.node.input", "thermal.building.service.input","year", "bias.adder")
  level2_data_names[["ThermalServiceCoef"]] <- c("region", "gcam.consumer", "nodeInput", "building.node.input", "thermal.building.service.input", "coef")
  ...
  level2_data_names[["GenericServiceAdder"]] <- c("region", "gcam.consumer", "nodeInput", "building.node.input", "building.service.input","year", "bias.adder")
  level2_data_names[["GenericServiceCoef"]] <- c("region", "gcam.consumer", "nodeInput", "building.node.input", "building.service.input", "coef")
  ...
  level2_data_names[["LN3ConstraintUnmgd"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", "UnmanagedLandLeaf", "land.constraint.policy")
  level2_data_names[["LN3ConstraintMgd"]] <- c("region", "LandAllocatorRoot", "LandNode1", "LandNode2", "LandNode3", "LandLeaf", "land.constraint.policy")
  ...
  level2_data_names[["StubTechResSecOutPMult"]] <- c("region", "supplysector", "subsector", "stub.technology", "year", "res.secondary.output", "pMultiplier")
