...
#' module_gcameurope_L1323.iron_steel
#'
...
#' the generated outputs: \code{L1323.out_Mt_R_iron_steel_Yh_EUR}, \code{L1323.IO_GJkg_R_iron_steel_F_Yh_EUR}, \code{L1323.in_EJ_R_iron_steel_F_Y_EUR}, \code{L1323.in_EJ_R_indenergy_F_Yh_EUR}, \code{L1323.SubsectorInterp_iron_steel_EUR}. The corresponding file in the
...
module_gcameurope_L1323.iron_steel <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    return(c("L1323.out_Mt_R_iron_steel_Yh_EUR",
    ...
    L1323.SubsectorInterp_iron_steel_EUR$to.year[which(L1323.SubsectorInterp_iron_steel_EUR$region %in% unique((L1323.index %>%
    ...
    L1322.in_EJ_R_indenergy_F_Yh_EUR %>%
      rename(raw = value) %>%
      left_join(L1323.in_EJ_R_iron_steel_F_Y_EUR %>%
                  group_by(GCAM_region_ID, year, fuel) %>%
    ...
    L1323.out_Mt_R_iron_steel_Yh_EUR %>%
      ...
      mutate(technology = subsector) %>%
      left_join(L1323.IO_GJkg_R_iron_steel_F_Yh_EUR, by = c("subsector", "technology", "GCAM_region_ID", "year")) %>%
      mutate(value = value * coefficient) %>%
    ...
    L1323.out_Mt_R_iron_steel_Yh_EUR %>%
      ...
      add_legacy_name("L1323.out_Mt_R_iron_steel_Yh_EUR") %>%
    ...
    L1323.SubsectorInterp_iron_steel_EUR %>%
      ...
      add_legacy_name("L1323.SubsectorInterp_iron_steel_EUR") %>%
      add_precursors("energy/A323.subsector_interp", "common/GCAM_region_names") ->
      L1323.SubsectorInterp_iron_steel_EUR



    return_data(L1323.SubsectorInterp_iron_steel_EUR, L1323.out_Mt_R_iron_steel_Yh_EUR,
                L1323.IO_GJkg_R_iron_steel_F_Yh_EUR, L1323.in_EJ_R_iron_steel_F_Y_EUR,
                L1323.in_EJ_R_indenergy_F_Yh_EUR)
