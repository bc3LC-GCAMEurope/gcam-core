...
#' module_gcameurope_L1324.Off_road
#'
...
#' the generated outputs: \code{L1324.in_EJ_R_Off_road_F_Y_EUR}, \code{L1324.in_EJ_R_indenergy_F_Yh_EUR}, \code{L1323.in_EJ_R_indfeed_F_Yh_EUR}. The corresponding file in the
...
module_gcameurope_L1324.Off_road <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    return(c("L1324.in_EJ_R_Off_road_F_Y_EUR",
    ...
    L1012.en_bal_EJ_R_Si_Fi_Yh_EUR %>%
      ...
      bind_rows(L1324.in_EJ_R_Off_road_F_Y_EUR) ->
      L1324.in_EJ_R_Off_road_F_Y_EUR
    ...
    L1323.in_EJ_R_indenergy_F_Yh_EUR %>%
      ...
      rename(raw = value) %>%
      left_join(L1324.in_EJ_R_Off_road_F_Y_EUR %>%
    ...
    L1324.in_EJ_R_indenergy_F_Yh_EUR %>%
      ...
      add_units("Exajoules") %>%
      add_comments("Subtracted Off_road energy use from industrial energy use values in L1323.in_EJ_R_indenergy_F_Yh_EUR") %>%
