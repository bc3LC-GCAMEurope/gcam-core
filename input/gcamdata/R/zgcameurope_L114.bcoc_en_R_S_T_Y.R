...
#' module_gcameurope_L114.bcoc_en_R_S_T_Y
#'
...
#' the generated outputs: \code{L114.bcoc_tgej_R_en_S_F_2000_EUR}. The corresponding file in the
...
#' @author GPK May 2017
module_gcameurope_L114.bcoc_en_R_S_T_Y <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L114.bcoc_tgej_R_en_S_F_2000_EUR <- BCOC_scaled_emissions %>%
    ...
    L114.bcoc_tgej_R_en_S_F_2000_trn <- L114.bcoc_tgej_R_en_S_F_2000_EUR %>%
