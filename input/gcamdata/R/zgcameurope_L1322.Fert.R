...
#' the generated outputs: \code{L1322.Fert_Prod_MtN_R_F_Y_EUR}, \code{L1322.IO_R_Fert_F_Yh_EUR}, \code{L1322.in_EJ_R_indenergy_F_Yh_EUR}, \code{L1322.in_EJ_R_indfeed_F_Yh_EUR}, \code{L1322.Fert_NEcost_75USDkgN_F_EUR}. The corresponding file in the
...
module_gcameurope_L1322.Fert <- function(command, ...) {
  ...
  MODULE_INPUTS <-
    c(FILE = "common/iso_GCAM_regID",
      ...
      FILE = "energy/IEA_Fert_fuel_data",  # TODO UPDATE??
      ...
      "L1322.IO_R_Fert_F_Yh") # to obtain the USA Fert value

  MODULE_OUTPUTS <-
    c("L1322.Fert_Prod_MtN_R_F_Y_EUR",
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    L1322.Fert_ALL_MtN_R_F_Y_adj %>%
      ...
      L1322.Fert_Prod_MtN_R_F_Y_EUR # Note that this is a final output table
    ...
    L1322.Fert_NEcost_75USDkgN_F_EUR <- tibble(fuel = c("gas", "gas CCS", "coal", "coal CCS", "refined liquids","hydrogen"),
    ...
    L1322.Fert_Prod_MtN_R_F_Y_EUR %>%
      ...
      add_legacy_name("L1322.Fert_Prod_MtN_R_F_Y_EUR") %>%
    ...
    L1322.IO_R_Fert_F_Yh_EUR %>%
      ...
      add_precursors("common/iso_GCAM_regID", "energy/mappings/IEA_ctry", "energy/IEA_Fert_fuel_data",
                     "L142.ag_Fert_Prod_MtN_ctry_Y", "L1321.in_EJ_R_indenergy_F_Yh_EUR",
                     "L132.in_EJ_R_indfeed_F_Yh_EUR") ->
      L1322.IO_R_Fert_F_Yh_EUR
    ...
    L1322.Fert_NEcost_75USDkgN_F_EUR %>%
      ...
      add_legacy_name("L1322.Fert_NEcost_75USDkgN_F_EUR") %>%
