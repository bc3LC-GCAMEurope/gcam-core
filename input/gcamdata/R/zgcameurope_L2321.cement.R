...
#' module_gcameurope_L2321.cement
#'
...
#' the generated outputs: \code{L2321.SectorLogitTables[[ curr_table ]]$data}, \code{L2321.Supplysector_cement_EUR}, \code{L2321.FinalEnergyKeyword_cement_EUR},
#' \code{L2321.SubsectorLogitTables[[ curr_table ]]$data}, \code{L2321.SubsectorLogit_cement_EUR}, \code{L2321.SubsectorShrwtFllt_cement_EUR},
...
module_gcameurope_L2321.cement <- function(command, ...) {
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    return(c("L2321.Supplysector_cement_EUR",
             ...
             "L2321.GlobalTechShrwt_cement_EUR",
             "L2321.GlobalTechCoef_cement_EUR",
             "L2321.GlobalTechCost_cement_EUR",
             "L2321.GlobalTechTrackCapital_cement_EUR",
             "L2321.GlobalTechCapture_cement_EUR",
             "L2321.GlobalTechShutdown_en_EUR",
             "L2321.GlobalTechSCurve_en_EUR",
             "L2321.GlobalTechLifetime_en_EUR",
             "L2321.GlobalTechProfitShutdown_en_EUR",
    ...
    L1321.out_Mt_R_cement_Yh_EUR <- get_data(all_data, "L1321.out_Mt_R_cement_Yh_EUR", strip_attributes = TRUE)
    ...
    # L2321.Supplysector_cement_EUR: Supply sector information for cement sector
    A321.sector %>%
      write_to_all_regions(c(LEVEL2_DATA_NAMES[["Supplysector"]], LOGIT_TYPE_COLNAME), GCAM_region_names) ->
      L2321.Supplysector_cement_EUR

    # L2321.FinalEnergyKeyword_cement_EUR: Supply sector keywords for cement sector
    A321.sector %>%
    ...
    # L2321.SubsectorLogit_cement_EUR: Subsector logit exponents of cement sector
    A321.subsector_logit %>%
      write_to_all_regions(c(LEVEL2_DATA_NAMES[["SubsectorLogit"]], LOGIT_TYPE_COLNAME), GCAM_region_names) ->
      L2321.SubsectorLogit_cement_EUR

    # and L2321.SubsectorShrwtFllt_cement_EUR: Subsector shareweights of cement sector
    A321.subsector_shrwt %>%
      filter(!is.na(year.fillout)) %>%
      write_to_all_regions(LEVEL2_DATA_NAMES[["SubsectorShrwtFllt"]], GCAM_region_names) ->
      L2321.SubsectorShrwtFllt_cement_EUR

    # L2321.SubsectorInterp_cement_EUR: Subsector shareweight interpolation of cement sector
    ...
    # L2321.StubTech_cement_EUR: Identification of stub technologies of cement
    ...
    # L2321.GlobalTechShrwt_cement_EUR: Shareweights of global cement technologies
    A321.globaltech_shrwt %>%
      gather_years %>%
    ...
    # L2321.GlobalTechCoef_cement_EUR: Energy inputs and coefficients of cement technologies
    ...
    # L2321.GlobalTechCapture_cement_EUR: CO2 capture fractions from global cement production technologies with CCS
    ...
    # L2321.GlobalTechCost_cement_EUR: Non-energy costs of global cement manufacturing technologies
    A321.globaltech_cost %>%
      ...
      L2321.GlobalTechCost_cement_EUR # intermediate tibble
    ...
    L2321.GlobalTechCost_cement_EUR %>%
      filter(technology %in% L2321.GlobalTechCapture_cement_EUR[["technology"]]) %>%
      mutate(input.cost = input.cost + cement_CCS_cost_75USD_tcement) %>%
      bind_rows(filter(L2321.GlobalTechCost_cement_EUR, !(technology %in% L2321.GlobalTechCapture_cement_EUR[["technology"]]))) %>%
    ...
    # L2321.StubTechProd_cement_EUR: calibrated cement production
    calibrated_techs %>%
    ...
    # L2321.StubTechCoef_cement_EUR: region-specific coefficients of cement production technologies
    ...
    # L2321.StubTechCalInput_cement_heat_EUR: calibrated cement production
    calibrated_techs %>%
      select(sector, fuel, supplysector, subsector, technology, minicam.energy.input) %>%
      distinct ->
      calibrated_techs_export # temporary tibble
    ...
    L1321.in_EJ_R_cement_F_Y_EUR %>%
      ...
      filter(!(supplysector %in% L2321.StubTechCoef_cement_EUR[["supplysector"]])) %>%
      mutate(stub.technology = technology,
             share.weight.year = year,
    ...
    # L2321.PerCapitaBased_cement_EUR: per-capita based flag for cement exports final demand
    A321.demand %>%
      write_to_all_regions(LEVEL2_DATA_NAMES[["PerCapitaBased"]], GCAM_region_names) ->
      L2321.PerCapitaBased_cement_EUR

    # L2321.BaseService_cement_EUR: base-year service output of cement
    L2321.StubTechProd_cement_EUR %>%
    ...
    # L2321.GlobalTechLifetime_en_EUR: Global tech lifetime
    ...
    # L2321.GlobalTechProfitShutdown_en_EUR: Global tech profit shutdown decider and parameters
    ...
    # L2321.PriceElasticity_cement_EUR: price elasticity
    A321.demand %>%
    ...
    L2321.Supplysector_cement_EUR %>%
      ...
      add_legacy_name("L2321.Supplysector_cement_EUR") %>%
    ...
    L2321.FinalEnergyKeyword_cement_EUR %>%
      ...
      add_legacy_name("L2321.FinalEnergyKeyword_cement_EUR") %>%
      add_precursors("energy/A321.sector", "common/GCAM_region_names") ->
      L2321.FinalEnergyKeyword_cement_EUR
    ...
    L2321.SubsectorLogit_cement_EUR %>%
      ...
      add_legacy_name("L2321.SubsectorLogit_cement_EUR") %>%
    ...
    L2321.SubsectorShrwtFllt_cement_EUR %>%
      ...
      add_legacy_name("L2321.SubsectorShrwtFllt_cement_EUR") %>%
    ...
    L2321.SubsectorInterp_cement_EUR %>%
      ...
      add_legacy_name("L2321.SubsectorInterp_cement_EUR") %>%
    ...
    L2321.StubTech_cement_EUR %>%
      ...
      add_legacy_name("L2321.StubTech_cement_EUR") %>%
    ...
    L2321.GlobalTechShrwt_cement_EUR %>%
      ...
      add_legacy_name("L2321.GlobalTechShrwt_cement_EUR") %>%
    ...
    L2321.GlobalTechCoef_cement_EUR %>%
      ...
      add_legacy_name("L2321.GlobalTechCoef_cement_EUR") %>%
    ...
    L2321.GlobalTechCost_cement_EUR %>%
      ...
      add_legacy_name("L2321.GlobalTechCost_cement_EUR") %>%
    ...
    L2321.GlobalTechTrackCapital_cement_EUR %>%
      ...
      same_precursors_as(L2321.GlobalTechCost_cement_EUR) ->
      L2321.GlobalTechTrackCapital_cement_EUR
    ...
    L2321.GlobalTechCapture_cement_EUR %>%
      ...
      add_legacy_name("L2321.GlobalTechCapture_cement_EUR") %>%
    ...
    L2321.StubTechProd_cement_EUR %>%
      ...
      add_units("Mt") %>%
      add_comments("Values are calculated using L1321.out_Mt_R_cement_Yh_EUR then added GCAM region information and supplysector, subsector, and technology information") %>%
      add_legacy_name("L2321.StubTechProd_cement_EUR") %>%
      add_precursors("energy/calibrated_techs", "L1321.out_Mt_R_cement_Yh_EUR", "common/GCAM_region_names") ->
      L2321.StubTechProd_cement_EUR

    L2321.StubTechCalInput_cement_heat_EUR %>%
      add_title("calibrated cement production") %>%
      add_units("EJ") %>%
      add_comments("Values are calculated using L1321.in_EJ_R_cement_F_Y_EUR then added GCAM region information and supplysector, subsector, technology, and input information") %>%
      add_legacy_name("L2321.StubTechCalInput_cement_heat_EUR") %>%
      add_precursors("energy/calibrated_techs", "L1321.in_EJ_R_cement_F_Y_EUR", "common/GCAM_region_names") ->
      L2321.StubTechCalInput_cement_heat_EUR

    L2321.StubTechCoef_cement_EUR %>%
      add_title("region-specific coefficients of cement production technologies") %>%
      add_units("limestone input is unitless (Mt limestone per Mt cement); all others are GJ per kg (EJ of energy per Mt of cement)") %>%
      add_comments("Coefficients are calculated using L1321.IO_GJkg_R_cement_F_Yh_EUR") %>%
      add_legacy_name("L2321.StubTechCoef_cement_EUR") %>%
      add_precursors("energy/calibrated_techs", "L1321.IO_GJkg_R_cement_F_Yh_EUR", "common/GCAM_region_names") ->
      L2321.StubTechCoef_cement_EUR
    ...
    L2321.PerCapitaBased_cement_EUR %>%
      ...
      add_legacy_name("L2321.PerCapitaBased_cement_EUR") %>%
      add_precursors("energy/A321.demand", "common/GCAM_region_names") ->
      L2321.PerCapitaBased_cement_EUR


    if(exists("L2321.GlobalTechShutdown_en_EUR")) {
      L2321.GlobalTechShutdown_en_EUR %>%
        ...
        add_legacy_name("L2321.GlobalTechShutdown_en_EUR") %>%
        add_precursors("energy/A321.globaltech_retirement") ->
        L2321.GlobalTechShutdown_en_EUR
    } else {
      missing_data() %>%
        add_legacy_name("energy/L2321.GlobalTechShutdown_en_EUR") ->
        L2321.GlobalTechShutdown_en_EUR
    }

    if(exists("L2321.GlobalTechSCurve_en_EUR")) {
      L2321.GlobalTechSCurve_en_EUR %>%
        ...
        add_legacy_name("L2321.GlobalTechSCurve_en_EUR") %>%
        add_precursors("energy/A321.globaltech_retirement") ->
        L2321.GlobalTechSCurve_en_EUR
    } else {
      missing_data() %>%
        add_legacy_name("energy/L2321.GlobalTechSCurve_en_EUR") ->
        L2321.GlobalTechSCurve_en_EUR
    }

    if(exists("L2321.GlobalTechLifetime_en_EUR")) {
      L2321.GlobalTechLifetime_en_EUR %>%
        ...
        add_legacy_name("L2321.GlobalTechLifetime_en_EUR") %>%
        add_precursors("energy/A321.globaltech_retirement") ->
        L2321.GlobalTechLifetime_en_EUR
    } else {
      missing_data() %>%
        add_legacy_name("energy/L2321.GlobalTechLifetime_en_EUR") ->
        L2321.GlobalTechLifetime_en_EUR
    }

    if(exists("L2321.GlobalTechProfitShutdown_en_EUR")) {
      L2321.GlobalTechProfitShutdown_en_EUR %>%
        ...
        add_legacy_name("L2321.GlobalTechProfitShutdown_en_EUR") %>%
        add_precursors("energy/A321.globaltech_retirement") ->
        L2321.GlobalTechProfitShutdown_en_EUR
    } else {
      missing_data() %>%
        add_legacy_name("energy/L2321.GlobalTechProfitShutdown_en_EUR") ->
        L2321.GlobalTechProfitShutdown_en_EUR
    }
    ...
    L2321.BaseService_cement_EUR %>%
      ...
      add_units("Mt") %>%
      add_comments("Transformed from L2321.StubTechProd_cement_EUR by adding energy.final.demand from A321.demand") %>%
      add_legacy_name("L2321.BaseService_cement_EUR") %>%
      add_precursors("energy/A321.demand", "energy/calibrated_techs", "L1321.out_Mt_R_cement_Yh_EUR", "common/GCAM_region_names") ->
      L2321.BaseService_cement_EUR
    ...
    L2321.PriceElasticity_cement_EUR %>%
      ...
      add_legacy_name("L2321.PriceElasticity_cement_EUR") %>%
      add_precursors("energy/A321.demand", "common/GCAM_region_names") ->
      L2321.PriceElasticity_cement_EUR
    ...
    return_data(L2321.Supplysector_cement_EUR, L2321.FinalEnergyKeyword_cement_EUR, L2321.SubsectorLogit_cement_EUR,
                ...
                L2321.GlobalTechSCurve_en_EUR, L2321.GlobalTechLifetime_en_EUR, L2321.GlobalTechProfitShutdown_en_EUR,
                L2321.PriceElasticity_cement_EUR, L2321.GlobalTechTrackCapital_cement_EUR)
  } else {
