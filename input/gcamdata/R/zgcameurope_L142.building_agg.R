...
#' module_gcameurope_L142.building_agg
#'
...
#' the generated outputs: \code{L142.in_EJ_R_bld_F_Yh_EUR}. The corresponding file in the
...
#' @author AS May 2017
module_gcameurope_L142.building_agg <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    return(c("L142.in_EJ_R_bld_F_Yh_EUR"))
    ...
    L142.in_EJ_R_bld_F_Yh_EUR %>%
      ...
      add_precursors("energy/A_regions", "gcam-europe/mappings/enduse_fuel_aggregation", "gcam-europe/mappings/enduse_sector_aggregation",
                     "L124.in_EJ_R_heat_F_Yh_EUR", "L131.in_EJ_R_Senduse_F_Yh_EUR", "L131.share_R_Senduse_heat_Yh_EUR") ->
      L142.in_EJ_R_bld_F_Yh_EUR

    return_data(L142.in_EJ_R_bld_F_Yh_EUR)
  } else {
