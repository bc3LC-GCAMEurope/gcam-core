...
module_gcameurope_L1327.paper <- function(command, ...) {
  ...
  MODULE_INPUTS <-
    c("L101.en_bal_EJ_R_Si_Fi_Yh_EUR",
  ...
  MODULE_OUTPUTS <-
    c("L1327.in_EJ_R_paper_F_Yh_EUR",
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    L1327.in_EJ_R_paper_F_Yh %>%
      ...
      add_precursors("L101.en_bal_EJ_R_Si_Fi_Yh_EUR", "energy/A_regions",
                     ...
                     "L123.in_EJ_R_indchp_F_Yh_EUR", "energy/paper_food_TFE", "energy/A327.china_biomass") ->
      L1327.in_EJ_R_paper_F_Yh
    ...
    L1327.out_Mt_R_paper_Yh %>%
      ...
      add_precursors( "L100.FAO_For_Prod_m3", "aglu/AGLU_ctry", "common/iso_GCAM_regID") ->
      L1327.out_Mt_R_paper_Yh
    ...
    L1327.IO_GJkg_R_paper_F_Yh %>%
      ...
      add_precursors("L101.en_bal_EJ_R_Si_Fi_Yh_EUR", "L100.FAO_For_Prod_m3", "aglu/AGLU_ctry", "energy/A_regions",
    ...
    L1327.in_EJ_R_indenergy_F_Yh %>%
      ...
      add_precursors("L101.en_bal_EJ_R_Si_Fi_Yh_EUR", "L1326.in_EJ_R_indenergy_F_Yh_EUR", "L100.FAO_For_Prod_m3",
