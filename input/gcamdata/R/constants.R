...
DISABLED_MODULES         <- "policy"              # Any functions containing this case-sensitive string will be disabled. "none" will disable module_gcamusa_L2231.nonewcoal
...
socioeconomics.FINAL_DEMAND_SECTORS <- c("other industrial energy use",
                                         ...
                                         paste0("resid cooling modern EUR_d", seq(1,10)),
                                         paste0("resid cooking modern EUR_d", seq(1,10)),
                                         paste0("resid cooking coal EUR_d", seq(1,10)),
                                         paste0("resid hot water modern EUR_d", seq(1,10)),
                                         paste0("resid hot water coal EUR_d", seq(1,10)),
                                         paste0("resid heating modern EUR_d", seq(1,10)),
                                         paste0("resid heating coal EUR_d", seq(1,10)),
                                         paste0("resid other appliance modern EUR_d", seq(1,10)),
                                         paste0("resid others modern EUR_d", seq(1,10)),
                                         paste0("resid others coal EUR_d", seq(1,10)),
                                         "comm cooling",
                                         "comm heating",
                                         "comm others",
                                         "comm cooling EUR",
