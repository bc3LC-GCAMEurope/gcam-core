...
#' module_gcameurope_L242.building_agg
#'
...
#' the generated outputs: \code{L242.Supplysector_bld_EUR}, \code{L242.FinalEnergyKeyword_bld_EUR},
#' \code{L242.SubsectorLogit_bld_EUR}, \code{L242.SubsectorShrwtFllt_bld_EUR}, \code{L242.SubsectorInterp_bld_EUR},
#' \code{L242.StubTech_bld_EUR}, \code{L242.StubTechCalInput_bld_EUR}, \code{L242.FuelPrefElast_bld_EUR},
#' \code{L242.PerCapitaBased_bld_EUR}, \code{L242.PriceElasticity_bld_EUR}, \code{L242.BaseService_bld_EUR}. The corresponding file in the
...
module_gcameurope_L242.building_agg <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    A42.sector %>%
      ...
      L242.Supplysector_bld_EUR # OUTPUT
    ...
    A42.sector %>%
      write_to_all_regions(LEVEL2_DATA_NAMES[["FinalEnergyKeyword"]],
                           GCAM_region_names = GCAM_region_names) ->
      L242.FinalEnergyKeyword_bld_EUR # OUTPUT
    ...
    A42.subsector_logit %>%
      ...
      L242.SubsectorLogit_bld_EUR # OUTPUT
    ...
    if(any(!is.na(A42.subsector_shrwt$year))) {
      A42.subsector_shrwt %>%
        ...
        L242.SubsectorShrwt_bld_EUR # OUTPUT (not generated at this time)
    }
    ...
    if(any(!is.na(A42.subsector_shrwt$year.fillout))) {
      A42.subsector_shrwt %>%
        ...
        L242.SubsectorShrwtFllt_bld_EUR # OUTPUT
    }
    ...
    if(any(is.na(A42.subsector_interp$to.value))) {
      A42.subsector_interp %>%
        ...
        L242.SubsectorInterp_bld_EUR # OUTPUT
    }
    ...
    if(any(!is.na(A42.subsector_interp$to.value))) {
      A42.subsector_interp %>%
        ...
        L242.SubsectorInterpTo_bld_EUR # OUTPUT (not generated at this time)
    }
    ...
    L242.in_EJ_R_bld_F_Yh %>%
      ...
      L242.StubTechCalInput_bld_EUR # OUTPUT
    ...
    A42.fuelprefElasticity %>%
      ...
      L242.FuelPrefElast_bld_EUR # OUTPUT
    ...
    A42.demand %>%
      write_to_all_regions(LEVEL2_DATA_NAMES[["PerCapitaBased"]],
                           GCAM_region_names = GCAM_region_names) ->
      L242.PerCapitaBased_bld_EUR # OUTPUT
    ...
    A42.demand %>%
      ...
      write_to_all_regions(LEVEL2_DATA_NAMES[["PriceElasticity"]],
                           GCAM_region_names = GCAM_region_names) ->
      L242.PriceElasticity_bld_EUR # OUTPUT
    ...
    L242.Supplysector_bld_EUR %>%
      ...
      add_legacy_name("L242.Supplysector_bld_EUR") %>%
    ...
    L242.FinalEnergyKeyword_bld_EUR %>%
      ...
      add_legacy_name("L242.FinalEnergyKeyword_bld_EUR") %>%
      add_precursors("common/GCAM_region_names", "energy/A42.sector") ->
      L242.FinalEnergyKeyword_bld_EUR
    ...
    if(exists("L242.SubsectorShrwtFllt_bld_EUR")) {
      L242.SubsectorShrwtFllt_bld_EUR %>%
        add_title("Subsector shareweights of building sector") %>%
        add_units("Unitless") %>%
        add_comments("Subsector shareweights of building sector were written for all regions") %>%
    ...
    if(exists("L242.SubsectorInterp_bld_EUR")) {
      L242.SubsectorInterp_bld_EUR %>%
    ...
    if(exists("L242.SubsectorInterpTo_bld_EUR")) {
      L242.SubsectorInterpTo_bld_EUR %>%
        add_title("Subsector shareweight interpolation data of building sector") %>%
        add_units("NA") %>%
        add_comments("Subsector shareweight interpolation data of building sector were written for all regions") %>%
    ...
    L242.PerCapitaBased_bld_EUR %>%
      ...
      add_units("Unitless") %>%
      add_comments("Data were written for all regions") %>%
      add_legacy_name("L242.PerCapitaBased_bld_EUR") %>%
    ...
    L242.PriceElasticity_bld_EUR %>%
      ...
      add_legacy_name("L242.PriceElasticity_bld_EUR") %>%
      add_precursors("energy/A42.demand") ->
      L242.PriceElasticity_bld_EUR
    ...
    return_data(L242.Supplysector_bld_EUR, L242.FinalEnergyKeyword_bld_EUR,
                L242.SubsectorLogit_bld_EUR, L242.SubsectorShrwt_bld_EUR,
                L242.SubsectorShrwtFllt_bld_EUR, L242.SubsectorInterp_bld_EUR,
                L242.SubsectorInterpTo_bld_EUR, L242.StubTech_bld_EUR,
                L242.StubTechCalInput_bld_EUR, L242.FuelPrefElast_bld_EUR,
                L242.PerCapitaBased_bld_EUR, L242.PriceElasticity_bld_EUR,
                L242.BaseService_bld_EUR)
  } else {
