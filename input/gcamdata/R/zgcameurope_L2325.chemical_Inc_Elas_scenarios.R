...
#' module_gcameurope_L2325.chemical_Inc_Elas_scenarios
#'
...
#' the generated outputs: \code{L2325.IncomeElasticity_chemical_Scen_EUR}.
...
#' @author CR 2026 Jan
module_gcameurope_L2325.chemical_Inc_Elas_scenarios <- function(command, ...) {
  ...
  MODULE_OUTPUTS <-
    c("L2325.IncomeElasticity_chemical_Scen_EUR")
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    L2325.IncomeElasticity_chemical_Scen_EUR %>%
      ...
      add_legacy_name("L2325.IncomeElasticity_chemical_Scen_EUR") %>%
