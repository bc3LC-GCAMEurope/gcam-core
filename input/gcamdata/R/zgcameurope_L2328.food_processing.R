...
#' module_gcameurope_L2328.food_processing
#'
...
#' the generated outputs: \code{L2328.SectorLogitTables[[ curr_table ]]$data}, \code{L2328.Supplysector_food_EUR}, \code{L2328.FinalEnergyKeyword_food_EUR},
#' \code{L2328.SubsectorLogitTables[[ curr_table ]]$data}, \code{L2328.SubsectorLogit_food_EUR}, \code{L2328.SubsectorShrwtFllt_food_EUR},
#' \code{L2328.SubsectorInterp_food_EUR}, \code{L2328.StubTech_food_EUR},
#' \code{L2328.StubTechCost_food_EUR}, \code{L2328.StubTechProd_food_EUR}, \code{L2328.StubTechCalInput_food_heat_EUR},
#' \code{L2328.StubTechCoef_food_EUR}, \code{L2328.StubCalorieContent_EUR}, \code{L2328.StubCaloriePriceConv_EUR},
#' \code{object}.
...
module_gcameurope_L2328.food_processing <- function(command, ...) {
  ...
  MODULE_INPUTS <-
    c(FILE = "common/GCAM_region_names",
      ...
      FILE = "gcam-europe/A328.globaltech_coef",
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    # L2328.FinalEnergyKeyword_food_EUR: Supply sector keywords for food processing sector
    A328.sector %>%
    ...
    # and L2328.SubsectorShrwtFllt_food_EUR: Subsector shareweights of food processing sector
    ...
    # L2328.SubsectorInterp_food_EUR: Subsector shareweight interpolation of food processing sector
    ...
    # L2328.StubTechCoef_food_EUR: region-specific coefficients of food processing technologies
    ...
    # L2328.StubTechCalInput_food_heat_EUR: calibrated food production inputs to process heat (including cogen)
    L2328.GlobalTechCoef_food %>%
      ...
      filter(!(supplysector %in% unique(L2328.StubTechCoef_food_EUR[["supplysector"]]))) -> # filter for process heat only
    ...
    L1328.in_EJ_R_food_F_Yh_EUR %>%
      ...
      # replace na later
      left_join(L1328.IO_EJPcal_R_food_F_Yh_EUR %>%
    ...
    # L2328.StubTechProd_food_EUR: calibrated food production
    calibrated_techs %>%
    ...
    # L2328.StubCalorieContent_EUR: demand for food processing set by food demand
    A328.demand %>%
    ...
    # L2328.StubCaloriePriceConv_EUR: price conversion for food processing input to food demand
    A328.demand %>%
    ...
    L2328.StubTechSecOut_food_EUR <- L123.eff_R_indchp_F_Yh_EUR %>%
      ...
      left_join_error_no_match(A328.globaltech_coef %>% select(supplysector, subsector, stub.technology = technology,
    ...
    L2328.StubTechSecPMult_food_EUR <- L2328.StubTechSecOut_food_EUR %>%
      select(LEVEL2_DATA_NAMES[["StubTechSecPmult"]])

    L2328.StubTechSecOut_food_EUR <- L2328.StubTechSecOut_food_EUR %>%
    ...
    L2328.StubTechSecPMult_food_EUR <-  bind_rows(L2328.StubTechSecPMult_food_EUR,
                                                  L2328.StubTechSecMarket_food_EUR %>%
                                                    select(LEVEL2_DATA_NAMES[["StubTechSecPmult"]]))

    L2328.StubTechSecMarket_food_EUR <- L2328.StubTechSecMarket_food_EUR %>%
    ...
    L2328.Supplysector_food_EUR %>%
      ...
      add_legacy_name("L2328.Supplysector_food_EUR") %>%
    ...
    L2328.FinalEnergyKeyword_food_EUR %>%
      ...
      add_legacy_name("L2328.FinalEnergyKeyword_food_EUR") %>%
      add_precursors("energy/A328.sector", "common/GCAM_region_names") ->
      L2328.FinalEnergyKeyword_food_EUR
    ...
    L2328.SubsectorLogit_food_EUR %>%
      ...
      add_legacy_name("L2328.SubsectorLogit_food_EUR") %>%
    ...
    L2328.SubsectorShrwtFllt_food_EUR %>%
      ...
      add_legacy_name("L2328.SubsectorShrwtFllt_food_EUR") %>%
    ...
    L2328.SubsectorInterp_food_EUR %>%
      ...
      add_legacy_name("L2328.SubsectorInterp_food_EUR") %>%
    ...
    L2328.StubTech_food_EUR %>%
      ...
      add_legacy_name("L2328.StubTech_food_EUR") %>%
    ...
    L2328.StubTechCost_food_EUR %>%
      ...
      add_legacy_name("L2328.StubTechCost_food_EUR") %>%
    ...
    L2328.StubTechProd_food_EUR %>%
      ...
      add_units("Pcal") %>%
      add_comments("Values are calculated using L1328.out_Pcal_R_food_Yh_EUR, then added GCAM region information and supplysector, subsector, and technology information") %>%
      add_legacy_name("L2328.StubTechProd_food_EUR") %>%
      add_precursors("energy/calibrated_techs",  "common/GCAM_region_names", "L1328.out_Pcal_R_food_Yh_EUR") ->
      L2328.StubTechProd_food_EUR

    L2328.StubTechCalInput_food_heat_EUR %>%
      add_title("calibrated food processing process heat production") %>%
      add_units("EJ") %>%
      add_comments("Values are calculated using L1328.in_EJ_R_food_F_Yh_EUR then added GCAM region information and supplysector, subsector, technology, and input information") %>%
      add_legacy_name("L2328.StubTechCalInput_food") %>%
      add_precursors("energy/calibrated_techs", "L1328.in_EJ_R_food_F_Yh_EUR", "common/GCAM_region_names",
                     "L1328.IO_EJPcal_R_food_F_Yh_EUR", "energy/A_regions", "energy/A328.globaltech_coef") ->
      L2328.StubTechCalInput_food_heat_EUR
    ...
    L2328.StubTechCoef_food_EUR %>%
      ...
      add_legacy_name("L2328.StubTechCoef_food_EUR") %>%
      add_precursors("energy/calibrated_techs", "common/GCAM_region_names", "L1328.IO_EJPcal_R_food_F_Yh_EUR") ->
      L2328.StubTechCoef_food_EUR
