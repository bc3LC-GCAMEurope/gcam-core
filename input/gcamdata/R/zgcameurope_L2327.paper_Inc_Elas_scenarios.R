...
#' module_gcameurope_L2327.paper_Inc_Elas_scenarios
#'
...
#' the generated outputs: \code{L2327.IncomeElasticity_paper_Scen_EUR}
...
#' @author CR 2026 Jan
module_gcameurope_L2327.paper_Inc_Elas_scenarios <- function(command, ...) {
  ...
  MODULE_OUTPUTS <-
    c("L2327.IncomeElasticity_paper_Scen_EUR")
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    L2327.IncomeElasticity_paper_Scen_EUR %>%
      ...
      add_legacy_name("L2327.IncomeElasticity_paper_Scen_EUR") %>%
