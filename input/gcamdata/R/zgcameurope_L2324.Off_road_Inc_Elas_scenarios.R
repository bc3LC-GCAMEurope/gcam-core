...
#' module_gcameurope_2324.Off_road_Inc_Elas_scenarios
#'
...
#' @author CR 2026 Jan
module_gcameurope_2324.Off_road_Inc_Elas_scenarios <- function(command, ...) {
  ...
  MODULE_OUTPUTS <-
    c("L2324.IncomeElasticity_Off_road_Scen_EUR")
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    L2324.IncomeElasticity_Off_road_Scen_EUR %>%
      ...
      add_legacy_name("L2324.IncomeElasticity_Off_road_Scen_EUR") %>%
