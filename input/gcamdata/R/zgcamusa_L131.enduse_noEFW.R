...
#' module_gcamusa_L131.enduse_noEFW
#'
...
#' @details This chunk performs the same steps as module_energy_L131.enduse, but works from the energy balances prior to the
...
module_gcamusa_L131.enduse_noEFW <- function(command, ...) {
