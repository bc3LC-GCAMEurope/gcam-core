...
#' module_gcameurope_L2323.iron_steel_Inc_Elas_scenarios
#'
...
#' the generated outputs: \code{L2323.IncomeElasticity_iron_steel_Scen}.
...
#' @author CR 2026 Jan
module_gcameurope_L2323.iron_steel_Inc_Elas_scenarios <- function(command, ...) {
  ...
  MODULE_OUTPUTS <-
    c("L2323.IncomeElasticity_iron_steel_Scen_EUR")
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    L2323.IncomeElasticity_iron_steel_Scen_EUR %>%
      ...
      add_legacy_name("L2323.IncomeElasticity_iron_steel_Scen_EUR") %>%
      ...
      add_precursors("common/GCAM_region_names",
                     ...
                     "L101.Pop_thous_SSP_R_Yfut",
                     "L101.Pop_thous_R_Yh_EUR",
                     "L102.pcgdp_thous90USD_Scen_R_Y_EUR",
                     "LB1092.Tradebalance_iron_steel_Mt_R_Y") ->
      L2323.IncomeElasticity_iron_steel_Scen_EUR
