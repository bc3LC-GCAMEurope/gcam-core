...
#' module_gcameurope_L2324.Off_road
#'
...
#' the generated outputs: \code{L2324.SectorLogitTables[[ curr_table ]]$data}, \code{L2324.Supplysector_Off_road_EUR}, \code{L2324.FinalEnergyKeyword_Off_road_EUR},
#' \code{L2324.SubsectorLogitTables[[ curr_table ]]$data}, \code{L2324.SubsectorLogit_Off_road_EUR}, \code{L2324.SubsectorShrwtFllt_Off_road_EUR},
#' \code{L2324.SubsectorInterp_Off_road_EUR}, \code{L2324.StubTech_Off_road_EUR}, \code{L2324.StubTechProd_Off_road_EUR}, \code{L2324.StubTechCalInput_Off_road_EUR},
#' \code{L2324.StubTechCoef_Off_road_EUR}, \code{L2324.PerCapitaBased_Off_road_EUR}, \code{L2324.BaseService_Off_road_EUR}, \code{L2324.PriceElasticity_Off_road_EUR},
...
module_gcameurope_L2324.Off_road <- function(command, ...) {
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    # L2324.Supplysector_Off_road_EUR: Supply sector information for Off_road sector
    A324.sector %>%
      write_to_all_regions(c(LEVEL2_DATA_NAMES[["Supplysector"]], LOGIT_TYPE_COLNAME), GCAM_region_names) ->
      L2324.Supplysector_Off_road_EUR

    # L2324.FinalEnergyKeyword_Off_road_EUR: Supply sector keywords for Off_road sector
    A324.sector %>%
    ...
    # L2324.SubsectorLogit_Off_road_EUR: Subsector logit exponents of Off_road sector
    A324.subsector_logit %>%
      write_to_all_regions(c(LEVEL2_DATA_NAMES[["SubsectorLogit"]], LOGIT_TYPE_COLNAME), GCAM_region_names) ->
      L2324.SubsectorLogit_Off_road_EUR

    # and L2324.SubsectorShrwtFllt_Off_road_EUR: Subsector shareweights of Off_road sector
    ...
    L2324.SubsectorShrwtFllt_Off_road_EUR %>%
      ...
      L2324.SubsectorShrwtFllt_Off_road_EUR_add

    L2324.SubsectorShrwtFllt_Off_road_EUR %>%
      mutate(year.fillout = as.numeric(year.fillout)) %>%
      bind_rows(L2324.SubsectorShrwtFllt_Off_road_EUR_add) ->
      L2324.SubsectorShrwtFllt_Off_road_EUR

    # L2324.SubsectorInterp_Off_road_EUR: Subsector shareweight interpolation of Off_road sector
    ...
    L2324.SubsectorInterp_Off_road_EUR %>%
      ...
      L2324.SubsectorInterp_Off_road_EUR_add

    L2324.SubsectorInterp_Off_road_EUR_add %>%
      mutate(from.year=2020,to.year = 2100,interpolation.function="linear") ->
      L2324.SubsectorInterp_Off_road_EUR_add2

    L2324.SubsectorInterp_Off_road_EUR %>%
      anti_join(L2324.SubsectorInterp_Off_road_EUR_add, by = c("region","supplysector","subsector")) %>%
      mutate(to.year = as.numeric(to.year),from.year = as.numeric(from.year)) %>%
      bind_rows(L2324.SubsectorInterp_Off_road_EUR_add,L2324.SubsectorInterp_Off_road_EUR_add2) ->
      L2324.SubsectorInterp_Off_road_EUR
    ...
    # L2324.StubTech_Off_road_EUR: Identification of stub technologies of Off_road
    ...
    # L2324.StubTechCalInput_Off_road_EUR: calibrated Off_road input
    L1324.in_EJ_R_Off_road_F_Y_EUR %>%
      filter(year %in% MODEL_BASE_YEARS) %>%
    ...
    L2324.in_EJ_R_Off_road_F_Y_tmp %>%
      ...
      L2324.StubTechCalInput_Off_road_EUR_tmp

    L2324.Off_road_tmp %>%
      left_join(L2324.StubTechCalInput_Off_road_EUR_tmp,
    ...
    # L2324.StubTechProd_Off_road_EUR: calibrated output of Off_road sector
    ...
    # L2324.StubTechCoef_Off_road_EUR: calibrated output of Off_road sector
    ...
    L2324.out_EJ_R_Off_road_serv_F_Yh %>%
      ...
      L2324.StubTechCoef_Off_road_EUR_base # intermediate tibble?
    ...
    L2324.StubTechCoef_Off_road_EUR_base %>%
    ...
    # L2324.PerCapitaBased_Off_road_EUR: per-capita based flag for Off_road exports final demand
    A324.demand %>%
      write_to_all_regions(LEVEL2_DATA_NAMES[["PerCapitaBased"]], GCAM_region_names)  ->
      L2324.PerCapitaBased_Off_road_EUR


    # L2324.BaseService_Off_road_EUR: base-year service output of Off_road
    L2324.out_EJ_R_Off_road_serv_F_Yh %>%
      filter(supplysector == "agricultural energy use" | supplysector == "mining energy use") %>%
      group_by(region, GCAM_region_ID, supplysector, year) %>%
      ...
      L2324.BaseService_Off_road_EUR_tmp
    ...
    L2324.StubTechProd_Off_road_EUR %>%
      ...
      ungroup() %>%
      bind_rows(L2324.BaseService_Off_road_EUR_tmp) ->
      L2324.BaseService_Off_road_EUR
    ...
    # L2324.PriceElasticity_Off_road_EUR: price elasticity
    A324.demand %>%
    ...
    L2324.Supplysector_Off_road_EUR %>%
      ...
      add_legacy_name("L2324.Supplysector_Off_road_EUR") %>%
    ...
    L2324.FinalEnergyKeyword_Off_road_EUR %>%
      ...
      add_legacy_name("L2324.FinalEnergyKeyword_Off_road_EUR") %>%
      add_precursors("energy/A324.sector", "common/GCAM_region_names") ->
      L2324.FinalEnergyKeyword_Off_road_EUR
    ...
    L2324.SubsectorLogit_Off_road_EUR %>%
      ...
      add_legacy_name("L2324.SubsectorLogit_Off_road_EUR") %>%
    ...
    L2324.SubsectorShrwtFllt_Off_road_EUR %>%
      ...
      add_legacy_name("L2324.SubsectorShrwtFllt_Off_road_EUR") %>%
    ...
    L2324.SubsectorInterp_Off_road_EUR %>%
      ...
      add_legacy_name("L2324.SubsectorInterp_Off_road_EUR") %>%
    ...
    L2324.StubTech_Off_road_EUR %>%
      ...
      add_legacy_name("L2324.StubTech_Off_road_EUR") %>%
    ...
    L2324.StubTechCalInput_Off_road_EUR %>%
      ...
      add_units("EJ") %>%
      add_comments("Values are calculated using L1324.in_EJ_R_Off_road_F_Y_EUR then added GCAM region information and supplysector, subsector, technology, and input information") %>%
      add_legacy_name("L2324.StubTechCalInput_Off_road_EUR") %>%
      add_precursors("energy/calibrated_techs", "L1324.in_EJ_R_Off_road_F_Y_EUR", "common/GCAM_region_names","energy/A324.globaltech_eff") ->
      L2324.StubTechCalInput_Off_road_EUR
    ...
    L2324.StubTechProd_Off_road_EUR %>%
      ...
      add_legacy_name("L2324.StubTechProd_Off_road_EUR") %>%
      add_precursors("energy/calibrated_techs", "L1324.in_EJ_R_Off_road_F_Y_EUR", "common/GCAM_region_names","energy/A324.globaltech_eff","energy/A324.globaltech_eff") ->
      L2324.StubTechProd_Off_road_EUR
    ...
    L2324.StubTechCoef_Off_road_EUR %>%
      ...
      add_legacy_name("L2324.StubTechCoef_Off_road_EUR") %>%
    ...
    L2324.PerCapitaBased_Off_road_EUR %>%
      ...
      add_legacy_name("L2324.PerCapitaBased_Off_road_EUR") %>%
    ...
    L2324.BaseService_Off_road_EUR %>%
      ...
      add_units("EJ") %>%
      add_comments("Transformed from L2324.StubTechProd_Off_road_EUR by adding energy.final.demand") %>%
      add_legacy_name("L2324.BaseService_Off_road_EUR") %>%
      add_precursors("energy/A324.demand","L1324.in_EJ_R_Off_road_F_Y_EUR", "energy/calibrated_techs", "common/GCAM_region_names","energy/A324.globaltech_eff") ->
      L2324.BaseService_Off_road_EUR
    ...
    L2324.PriceElasticity_Off_road_EUR %>%
      ...
      add_legacy_name("L2324.PriceElasticity_Off_road_EUR") %>%
      add_precursors("energy/A324.demand", "common/GCAM_region_names") ->
      L2324.PriceElasticity_Off_road_EUR

    return_data(L2324.Supplysector_Off_road_EUR, L2324.FinalEnergyKeyword_Off_road_EUR, L2324.SubsectorLogit_Off_road_EUR,
                L2324.SubsectorShrwtFllt_Off_road_EUR, L2324.SubsectorInterp_Off_road_EUR, L2324.StubTech_Off_road_EUR,
                L2324.StubTechCalInput_Off_road_EUR,L2324.StubTechCoef_Off_road_EUR, L2324.StubTechProd_Off_road_EUR,
