...
#' module_gcameurope_L132.industry
#'
...
#' the generated outputs: \code{L132.in_EJ_R_indenergy_F_Yh_EUR}, \code{L132.in_EJ_R_indfeed_F_Yh_EUR}. The corresponding file in the
#' original data system was \code{LA132.industry.R} (energy level1).
#' @details The chunk calculates industrial feedstock consumption directly separated from end-use energy consumption and
...
module_gcameurope_L132.industry <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    return(c("L132.in_EJ_R_indenergy_F_Yh_EUR",
    ...
    L122.in_EJ_R_gasproc_F_Yh_EUR %>%
      filter(fuel == "gas") %>%
      left_join_error_no_match(L122.in_EJ_R_gasproc_F_Yh_EUR, by = c("GCAM_region_ID", "sector", "fuel", "year")) %>%
      left_join_error_no_match(L122.out_EJ_R_gasproc_F_Yh_EUR, by = c("GCAM_region_ID", "sector", "fuel", "year")) %>%
    ...
    L123.in_EJ_R_indchp_F_Yh_EUR -> L132.in_EJ_R_indchp_F_Yh
    ...
    L132.in_EJ_R_indenergy_F_Yh_EUR %>%
      ...
      add_precursors("energy/A_regions", "gcam-europe/mappings/enduse_sector_aggregation", "gcam-europe/mappings/enduse_fuel_aggregation",
    ...
    L132.in_EJ_R_indfeed_F_Yh_EUR %>%
      ...
      add_precursors("L131.in_EJ_R_Senduse_F_Yh_EUR", "gcam-europe/mappings/enduse_sector_aggregation", "gcam-europe/mappings/enduse_fuel_aggregation") ->
      L132.in_EJ_R_indfeed_F_Yh_EUR
